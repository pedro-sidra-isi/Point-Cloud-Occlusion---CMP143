...
void main()
{
    ...
    vec3 ambient_color = materials[vMaterialIdx].ambient;
    vec3 diffuse_color = materials[vMaterialIdx].diffuse;
    vec3 specular_color = materials[vMaterialIdx].specular;
    float shine = materials[vMaterialIdx].shine;
