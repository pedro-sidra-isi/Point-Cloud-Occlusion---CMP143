...
void Shader::SetUniform4f(const std::string &name, const float *f) {
  GLCall(glUniform4f(GetUniformLocation(name), f[0], f[1], f[2], f[3]));
}

void Shader::SetUniform3f(const std::string &name, const float *f) {
  GLCall(glUniform3f(GetUniformLocation(name), f[0], f[1], f[2]));
}
