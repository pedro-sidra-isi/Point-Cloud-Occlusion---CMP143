...
bool inline GLCheckError() {
  while (GLenum error = glGetError()) {
    ...
    case GL_INVALID_ENUM:
      std::cout << "GL_INVALID_ENUM : An unacceptable value is specified for "
    ...
    case GL_INVALID_OPERATION:
      std::cout << "GL_INVALID_OPERATION : The specified operation is not "
                   "allowed in the current state.";
      break;
    case GL_INVALID_FRAMEBUFFER_OPERATION:
      std::cout << "GL_INVALID_FRAMEBUFFER_OPERATION : The framebuffer object "
                   "is not complete.";
      break;
    case GL_OUT_OF_MEMORY:
      std::cout << "GL_OUT_OF_MEMORY : There is not enough memory left to "
                   "execute the command.";
      break;
    ...
    //   std::cout << "GL_STACK_OVERFLOW : An attempt has been made to perform
    //   an "
